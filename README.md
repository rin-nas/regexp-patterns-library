...
### Числа
* Целые: `/^[-−]? (?:[1-9]\d*|0) $/sx`
* Целые и десятичные: `/^[-−]? (?:[1-9]\d*|0) (?:\.\d*[1-9])? $/sx`
* Денежный формат: `/^[-−]? (?:[1-9]\d*|0) (?:\.\d*[1-9])? $/sx`
* Число с разделением тысячных через запятую и десятичными: [PCRE](https://regex101.com/r/FH4QLj/3/)
